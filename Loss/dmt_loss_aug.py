...
class MyLoss(nn.Module):
    ...
    def forward(self, input_data, latent_data, rho, sigma, v_latent, ):
        ...
        # print(input_data.shape, latent_data.shape)
        ...
        # print(input_data.shape, data.shape, dis_P.shape)
        ...
        # print(dis_P.shape, downDistance.shape, rightDistance.shape, rightdownDistance.shape)
        # print(dis_P.shape, downDistance.shape, torch.cat([dis_P, downDistance]).shape)
        ...
        # print(latent_data[latent_data < 0])
        dis_Q = self._DistanceSquared(latent_data)
        # print(disInput.shape, dis_Q.shape)
        Q = self._Similarity(
            dist=dis_Q,
            rho=0,
            sigma_array=1,
